...
export default function EditIntervenantForm({
  ...
  const updateIntervenantWithId = (formData: FormData) => updateIntervenant(initialState, formData, intervenant.id.toString());
  const [state, setState] = useState(initialState);

  const formAction = async (formData: FormData) => {
    const result = await updateIntervenantWithId(formData);
    setState(result);
  };
